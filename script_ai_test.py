...
if __name__ == "__main__":
    ...
    combat_mode_trigger_coroutine = asynctriggers.async_combat_mode_trigger(
                                        combat_mode_coroutine,
                                        combat_mode_condition_fcn,
                                        mode_cancel_condition_fcn,
                                        combat_mode_cooldown)

    regroup_mode_trigger_coroutine = asynctriggers.async_regroup_mode_trigger(
    ...
    print("press J to exit")
    time_log = []
    screencap_log = []
    start_time = time.clock()
    win32api.GetAsyncKeyState(ord(exit_script_key))  # clear recent presses
        ...
        try:
            while True:
                ...
                while not future.done():
                    ...
                    if win32api.GetAsyncKeyState(ord(exit_script_key)):
